About click-help-colors-feedstock
=================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/click-help-colors-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2824&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/click-help-colors-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `click-help-colors` can be installed with `conda`:
...
```
mamba install click-help-colors
```

It is possible to list all of the versions of `click-help-colors` available on your platform with `conda`:
...
```
mamba search click-help-colors --channel conda-forge
```
...
mamba repoquery search click-help-colors --channel conda-forge

# List packages depending on `click-help-colors`:
mamba repoquery whoneeds click-help-colors --channel conda-forge

# List dependencies of `click-help-colors`:
mamba repoquery depends click-help-colors --channel conda-forge
```
